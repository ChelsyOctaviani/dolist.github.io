...
<div class="container bg-light p-4 rounded shadow">
    ...
    <!-- Menampilkan notifikasi jika ada pesan edit -->
    ...
    <!-- Menampilkan notifikasi jika ada pesan hapus -->
    ...
    <table class="table table-bordered table-light text-dark">
        ...
        <!-- Menampilkan daftar tugas dari database -->
        <?php
        $no = 1;
